...
<script type="text/javascript">
	function gopage(pageNum) {
		alert(pageNum)
		var url = "/article/selectByChannelId?pageNum=" + pageNum
...
<body>
	<div style="height: 30px; background-color: black" class="col-md-12"
		align="right">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12" style="background-color: white">
				<img alt="" src="/resource/images/111.jpg" width="200" height="100"
					class=""> &nbsp;&nbsp;&nbsp; <font
					style="font-size: 25px; color: red; font-family: '宋体'; font-weight: bolder;">CMS首页</font>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-2 min_h_500">
				<ul class="">
					<li class="channel-item ${article.channel_id==null?'active':''}"><a
						href="/main?hot=1" id="a2">热门</a></li>
					<c:forEach items="${channelList}" var="c">
						<li class="channel-item ${article.channel_id==c.id?'active':''}"><a
							href="/main?channel_id=${c.id}" id="a2">${c.name}</a></li>
					</c:forEach>
				</ul>
			</div>
			<!-- 中中 -->
			<div class="col-md-7 split min_h_500" id="cc">
			...
			<div class="col-md-3 split min_h_500">
				...
				<br>
				<div class="card" style="width: 18rem">
					<div class="card-header">最热文章</div>
					<ul class="list-group list-group-flush">
						<c:forEach items="${hot}" var="b">
							<li class="list-group-item"><a href="">${b.title}</a></li>
						</c:forEach>
					</ul>
				</div>
