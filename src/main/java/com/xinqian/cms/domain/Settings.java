...
public class Settings implements Serializable{
	 ...
	 * @Description: TODO
	 */
	private static final long serialVersionUID = -4142381983152101654L;
	private Integer id;
	private String site_domain;
	private String site_name;
	private Integer article_list_size;
	private Integer article_size;
	private String slide_size;
	...
	public Settings(Integer settings_id, String site_domain, String site_name, Integer article_list_size,
			Integer article_size, String slide_size, String admin_username, String admin_password) {
		super();
		this.id = id;
	...
	public Integer getArticle_size() {
		return article_size;
	}
	public void setArticle_size(Integer article_size) {
		this.article_size = article_size;
	}
	...
	public String toString() {
		return "Settings [id=" + id + ", site_domain=" + site_domain + ", site_name=" + site_name
				+ ", article_list_size=" + article_list_size + ", article_size=" + article_size + ", slide_size="
				+ slide_size + ", admin_username=" + admin_username + ", admin_password=" + admin_password + "]";
	}
